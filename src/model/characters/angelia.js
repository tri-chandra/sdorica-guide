...
export const angelia_n = new Angelia({
  tier: n,
  title: 'Thy Fair Lady',
  passive: {
    name: 'Helpful Halo',
...
export const angelia_sr = new Angelia({
  tier: sr,
  title: 'Unfazed Dame',
  passive: {
    name: 'Helpful Halo',
...
export const angelia_ssr = new Angelia({
  tier: ssr,
...
export const angelia_skin = new Angelia({
  tier: skin,
...
export const angelia_sp = new AngeliaSP({
  tier: sp,
